...
In the default grub config, find the GRUB_CMDLINE_LINUX and add (with quotes):
...
Flatseal is a permissions manager for flatpaks.  Install it using this command:

```console
flatpak install flathub com.github.tchx84.Flatseal
```

Afterwards, you can allow flatpak apps access to the network, or devices on your laptop.  Run the app from Activities and configure your apps appropriately.